        ...
        <div class="pt-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="grid grid-cols-4">
                    <div class="pb-9 col-start-1 col-end-2">
                    <button
                        class="py-2 px-4 rounded  text-gray-500"
                        @click="deleteRow(todo)"
                    >
                        削除
                    </button>
                    </div>

                   <div class="pb-9 col-start-4 col-end-5 flex flex-row-reverse">
                    <button
                        class="py-2 px-4 rounded text-gray-500"
                        @click="edit(todo)"
                    >
                ...
                >
                    ...
                    <div
                        ...
                        class="bg-red-100 border-t-4 border-red-500 rounded-b text-teal-900 px-4 py-3 shadow-md my-3"
                        role="alert"
                    >
                        <div class="flex">
                            <div>
                        ...
                        >
                            <ul class="divide-y divide-gray-200">
                                <li v-for="todo in todos.data" :key="todo.id">
                                    <a
                                        class="block hover:bg-gray-50 dark:hover:bg-gray-900"
                                    >
                                        <div
                                        ...
                                        >
                                            <div class="grid grid-cols-4 gap-4">
                                                ...
                                                <p
                                                    class="text-md text-gray-700 dark:text-white md:truncate col-span-2"
                                                    :class="{
                                                        'line-through':
                                                            todo.is_checked,
                                                    }"
                                            ...
                                            <div class="col-span-2">
                                                <p
                                                    class="text-md font-light text-gray-500 dark:text-gray-300"
                                                    :class="{
                                                        'line-through':
                                                            todo.is_checked,
                                                    }"
                                    ...
                                    >
                                        <div class="">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                ></textarea>
                                                <!-- <JetInputError :message="form.errors.content" class="mt-2 text-red-500"/> -->
                                            </div>
                                        </div>
                                    </div>
                                    <div
